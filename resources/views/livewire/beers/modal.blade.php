<div>
    ...
    <x-modal wire:model="modalOpen" :title="!empty($form->model) ? 'Edit Beer' : 'Create Beer'">
        <form wire:submit="save">
            ...
            <x-form.field label="Brewery" name="brewery_id" error="form.brewery_id">
                <x-form.searchable-select id="brewery_id" name="brewery_id" :options="$breweries"
                    wire:model="form.brewery_id" />
            </x-form.field>

            <x-form.field label="Style" name="style_id" error="form.style_id">
                <x-form.searchable-select id="style_id" name="style_id" :options="$styles" wire:model="form.style_id" />
            </x-form.field>

            <x-form.field label="ABV" name="abv" error="form.abv">
                <x-form.input id="abv" name="abv" type="number" step="0.1" wire:model="form.abv" />
            </x-form.field>
